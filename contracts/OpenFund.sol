...
/**
  ...
  @author Peter Mazzocco
    ...
    Lastly, I've added incentives like "boost" that will allow someone to set true 
    to a bool on their campaign to increase visibility on a front end. 
    This is to allow easier tracking for highlighting campaigns on a dApp and is 
    totally optional.

    Testing done in Hardhat and can be viewed in the /test folder
*/
...
contract OpenFund {
    ...
    */
    ...
    /*  
        ...
        campaigns, just ones that come from the boost function.
